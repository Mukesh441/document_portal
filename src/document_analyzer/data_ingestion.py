...
if __name__ == "__main__":
    ...
    pdf_path = r"C:\\Users\\MSE226\\Desktop\\LLM_OPS_PRAC\\DOCUMENT_PORTAL\\data\\document_analysis\\sample.pdf"
    # os.path.join(os.getcwd(), "data", "document_analysis", "sample.pdf")
    class DummyFile:
